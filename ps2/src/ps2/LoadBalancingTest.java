...
public class LoadBalancingTest {
    ...
    public void testInvalid() {
        int[] jobsizes = {1,2,3,4,5,6};
        System.out.println(LoadBalancing.isFeasibleLoad(jobsizes,10,-5));
    }
    ...
    @Test
    public void testInvalidFindLoad() {
        int[] jobSizes = {};
        System.out.println(LoadBalancing.findLoad(jobSizes,1));
